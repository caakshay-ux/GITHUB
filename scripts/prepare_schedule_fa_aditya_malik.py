#!/usr/bin/env python3
"""
Schedule FA / CG / Dividends for Aditya Malik — IBKR U15181144.

Inputs: FY Activity Statements only (Aug 20 2024–Mar 31 2025; Apr 1 2025–Mar 31 2026).
...
INCEPTION = ROOT / "input_Inception_FY2024-25_Aditya_Malik.csv"
FISCAL = ROOT / "input_Fiscal_Statement_Aditya_Malik.csv"
ANNUAL = ROOT / "input_Annual_Statement_Aditya_Malik.csv"
OUT = ROOT / "output" / "Foreign_Assets_Schedule_FA_Aditya_Malik_AY2026-27.xlsx"
...
NOTES = [
    ("Assessee", "Aditya Malik — IBKR U15181144 — Advisor: MATCAP WEALTH ADVISORS PRIVATE LIMITED"),
    (
        "Account opening",
        "First activity 20-Aug-2024 via FOP transfer of ACN (400 + 455 shares). "
        "IBKR cost basis used for remaining ACN lots; CG uses IBKR sell Basis.",
    ),
    (
    ...
    ("LRCX split", "10-for-1 split on 02/03-Oct-2024 applied in FIFO"),
    ("Shell", "R6C0d / SHELL treated as one security (Shell plc); dividend rights excluded from CG"),
    ("JPY holdings", "2914.T / 4568.T / 7203.T converted via IBKR YE JPY→USD then Rule 115 USD/INR (editable on CG)"),
]
...
def run():
    ...
    main(
        ...
        fiscal=FISCAL,
        out=OUT,
        account_open_date="2024-08-20 (first inbound FOP transfer — ACN)",
        assessee_label="Aditya Malik",
        notes_extra=NOTES,
    )
