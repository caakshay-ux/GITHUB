...
def synthesize_annual(src: Path, annual_out: Path) -> None:
    ...
    add(
        ...
        "Data",
        "WhenGenerated",
        "Synthesized empty CY2025 shell — account opened 30-Jan-2026 (see Notes)",
    )
...
NOTES = [
    ("Assessee", "Rajani J Vallath and Sanjeev K Nair — IBKR U21864112 (Joint) — Advisor: MATCAP WEALTH ADVISORS PRIVATE LIMITED"),
    ("Customer type", "Joint account — report beneficial ownership / share of income per ITR instructions"),
    (
        "Account opening",
        "Opened 30-Jan-2026 via Internal transfer In of AVGO × 180 from U16003525 "
        "(carryover cost basis ~USD 62.772/share; transfer MV USD 59,702.40). "
        "No cash deposits in the statement period.",
    ),
    (
        "Schedule FA CY2025",
        "Account did not exist in calendar year 2025 (opened 30-Jan-2026). "
...
def run():
    ...
    main(
        ...
        fiscal=FISCAL,
        out=OUT,
        account_open_date="2026-01-30 (Internal transfer In of AVGO from U16003525)",
