...
Inputs:
  - FY2024-25 + FY2025-26 Activity Statements
...
FISCAL_FY2627 = ROOT / "input_Fiscal_Statement_FY2026-27_Kohli_U16755051.csv"
...
NOTES = [
    ...
    (
        "FY2026-27 YTD",
        "Partial Activity Statement 01-Apr-2026–14-Sep-2026. Multi-currency sales (USD/EUR/HKD) "
        "and dividends; APH 2-for-1 split 03-Sep-2026. See Capital Gains FY2026-27 / Schedule OS - FY2026-27. "
        "Full FY needs statement through 31-Mar-2027.",
    ),
]
...
def run():
    ...
    append_fy2026_27(
        ...
        extra_notes=[
            (
                "APH split",
                "APH 2-for-1 stock split on 03-Sep-2026 applied in FIFO for FY2026-27 holdings.",
            ),
        ],
    )
    print(f"Wrote {OUT}")
